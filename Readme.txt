...
----------
CtxMgr is a lightweight context tool. You can quickly invoke it by pressing the hotkey (default: Alt+Z) at any time,
and hide it or return it to the system tray by pressing the same hotkey or the ESC key again.
...
# The following functions are supported for numerical calculations:
+---------------+------------------------------------------------------------------------------------------------------+---------------------+--------+--+
...
Contact Information
----------
Email: 55154717@qq.com

Author's Homepage: https://www.ctxmgr.com
